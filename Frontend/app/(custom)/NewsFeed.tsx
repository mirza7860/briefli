...
const trackTimeSpent = async (newsId, title, category, subcategory) => {
...
//   const handleTransition = (direction: "in" | "out") => {
//     Animated.timing(fadeAnim, {
//       toValue: direction === "in" ? 0.8 : 1,
//       duration: 400,
//       useNativeDriver: true,
...
//           item.id === id
//             ? { ...item, views: item.views + 1, viewCountIncreased: true }
//             : item
//         );
...
//   const [viewableItem, setViewableItem] = useState<string | null>(null);
//   const [showScrollToTop, setShowScrollToTop] = useState(false);
//   const [currentIndex, setCurrentIndex] = useState<number | null>(null); // State for TTS
//   const flatListRef = useRef<FlatList>(null);
...
//   const handleScroll = (event: any) => {
//     const offsetY = event.nativeEvent.contentOffset.y;
//     setShowScrollToTop(offsetY > 200); // Show button after scrolling down 200px
//   };
...
//   const handleLongPress = (url: string) => {
//     Clipboard.setString(url);
//     Toast.show("Link copied to clipboard!", 2000, {
//       textColor: "blue",
//     });
//   };
...
//     if (isEndOfList && currentIndex < newsData.length - 1) {
//       const nextIndex = currentIndex === null ? 0 + 1 : currentIndex + 1;
//       console.log("Next Index:", nextIndex); // Log nextIndex
